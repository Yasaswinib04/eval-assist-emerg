...
import { BookCheck, Zap, Shield, TrendingUp, ArrowRight, Loader2 } from "lucide-react";
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 h-12 px-8 rounded-lg bg-blue-800 text-white font-medium hover:bg-blue-900 transition-colors shadow-sm text-base disabled:opacity-60"
              >
                {googleLoading ? <><Loader2 size={16} className="animate-spin" /> Connecting...</> : (
            ...
            <p className="mt-3 text-sm text-stone-500">Takes 30 seconds · Uses pre-loaded sample data</p>
