...
import { BookCheck, Zap, Shield, TrendingUp, Loader2, ArrowRight, LogIn } from "lucide-react";
              ...
              {googleConfigured ? (
                <>
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-3 h-14 px-10 rounded-xl bg-blue-800 text-white font-semibold hover:bg-blue-900 transition-colors shadow-lg text-lg disabled:opacity-60"
                  >
                    {googleLoading ? (
                      ...
                      <>
                        ...
                        Sign in with Google to explore the demo
                      </>
                    ) : (
                      "Loading Google..."
                    )}
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 max-w-md">
                  <p className="text-sm text-amber-800 font-medium mb-3">Google sign-in not configured on this server</p>
                  <p className="text-xs text-amber-700 mb-4">Add <code className="bg-amber-100 px-1.5 py-0.5 rounded text-[11px] font-mono">GOOGLE_CLIENT_ID</code> to your environment variables, or use direct sign-in below.</p>
                  <button
                    onClick={() => navigate("/login")}
                    className="inline-flex items-center gap-2 h-10 px-5 rounded-lg bg-blue-800 text-white text-sm font-medium hover:bg-blue-900 transition-colors"
                  >
