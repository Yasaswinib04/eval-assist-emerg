...
const Login = () => {
  const { t, login, googleLogin, loginWithName } = useApp();
      ...
      <div className="flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-6 pb-12">
          <div className="w-full max-w-md">
            ...
            <p className="mt-2 text-stone-600">Explore the demo with pre-loaded data.</p>
            ...
            <div className="mt-6 space-y-3">
              ...
              >
                {demoLoading ? <><Loader2 size={16} className="animate-spin" /> Loading...</> : "Try Demo →"}
              </button>
