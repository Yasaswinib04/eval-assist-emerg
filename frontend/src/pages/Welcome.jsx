...
const Welcome = () => {
  const { t, loginWithName, user } = useApp();
        ...
        <div className="w-full max-w-md">
          <div className="bg-white border border-stone-200 rounded-2xl shadow-sm p-8">
            ...
            <div className="mt-6">
              ...
              <button
                disabled
                className="mt-4 w-full h-12 rounded-lg border border-stone-300 bg-stone-50 text-stone-500 font-medium inline-flex items-center justify-center gap-2 relative"
              >
                ...
                <span className="absolute -top-1 -right-1 px-1.5 py-0.5 rounded-full bg-amber-100 text-amber-800 text-[9px] font-bold border border-amber-200">SOON</span>
              </button>
            </div>

            <div className="mt-6 flex items-start gap-2 text-xs text-stone-400">
              <Shield size={14} className="shrink-0 mt-0.5" />
              <span>Your name stays on this device. We don't store anything yet.</span>
            </div>
