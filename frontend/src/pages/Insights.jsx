  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-8 md:py-12" data-testid="insights-page">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <KpiCard testId="kpi-class-avg" label={t("classAverage")} value={assessment.totalMarks ? `${((assessment.avgScore / assessment.totalMarks) * 100).toFixed(0)}%` : "--"} sub={assessment.totalMarks ? `${assessment.avgScore.toFixed(1)} / ${assessment.totalMarks}` : "No marks"} icon={Users} accent="bg-blue-50 text-blue-800" />
